...
public class InputManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        EventManager.disableDash.AddListener(DisableDash);
        EventManager.disableDefence.AddListener(DisableDefence);
        EventManager.disableMovement.AddListener(DisableMovement);
        EventManager.disableMouse.AddListener(DisableMouse);
        EventManager.disableInventory.AddListener(DisableInventory);
    }
    ...
    void OpenCloseInventory()
    {
        if (!disableInventory)
            if (Input.GetKeyDown(KeyCode.Tab))
            {
                ...
                DisableMouse();
                EventManager.inventoryOpen.Invoke();
            }
    }
